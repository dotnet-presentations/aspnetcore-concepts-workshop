...
1. Look at the Tag Helpers attributes being used in this view (examples: asp-controller, asp-validation-summary) and play around with setting their attributes and exploring the IntelliSense offered for the different attribute types
...
1. Open the `_ViewImports.cshtml` file and add line to register your Tag Helper: `@addTagHelper "*, Lab6"` (adjust WebApplication49 to your assembly name)
