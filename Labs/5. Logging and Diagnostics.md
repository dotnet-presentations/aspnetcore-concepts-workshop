...
1. Change the minimum log level for the console logger in `appsettings.json`:
...
> **Note:** Completed code for this section is found [/Labs/Code/Lab5A](/Labs/Code/Lab5A).
...
> **Note:** Completed code for this section is found [/Labs/Code/Lab5B](/Labs/Code/Lab5B).
...
> **Note:** Completed code for this section is found [/Labs/Code/Lab5C](/Labs/Code/Lab5C).
...
> **Note:** Completed code for this section is found [/Labs/Code/Lab5D](/Labs/Code/Lab5D).
